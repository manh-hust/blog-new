...
!(function (a, b) {
        ...
        a.dataSource || c('"dataSource" is required.'),
            'string' == typeof a.dataSource
                ...
                : i.isObject(a.dataSource) &&
                  (void 0 === a.locator
                      ? c(
                            '"dataSource" is an Object, please specify "locator".',
                        )
    ...
    b.fn.pagination && (g = 'pagination2'),
                ...
                l = {
                        ...
                        if (
                            ...
                            a.parseDataSource(k.dataSource, function (b) {
                                (a.isAsync = i.isString(b)),
                                    i.isArray(b) &&
                                        (c.totalNumber = k.totalNumber =
                                            b.length),
                                    (a.isDynamicTotalNumber =
                                        a.isAsync && k.totalNumberLocator);
                                var d = a.render(!0);
                    ...
                    generateHTML: function (a) {
                        var c,
                            ...
                            C = b.isFunction(k.autoHideNext)
                                ? k.autoHideNext()
                                : k.autoHideNext,
                            D = b.isFunction(k.header)
                                ? k.header(e, f, g)
                                : k.header,
                            E = b.isFunction(k.footer)
                                ? k.footer(e, f, g)
                                : k.footer;
                        return (
                            D &&
                        ...
                        if (!e.disabled) {
                            ...
                            if ((g = parseInt(g)) && !(g < 1)) {
                                ...
                                if (!(l > 0 && g > m)) {
                                    ...
                                    var n = {},
                                        o = k.alias || {};
                                    (n[o.pageSize ? o.pageSize : 'pageSize'] =
                                        h),
                                        (n[
                                            o.pageNumber
                                                ? o.pageNumber
                                    ...
                                    b.extend(!0, q, p),
                                        ...
                                        (q.success = function (a) {
                                            e.isDynamicTotalNumber
                                                ? e.findTotalNumberFromRemoteResponse(
                                                      a,
                                                  )
                                                : (e.model.totalNumber =
                                                      k.totalNumber),
                    ...
                    getLocator: function (a) {
                        ...
                        return (
                            'string' == typeof a
                                ...
                                ? (d = a())
                                : c(
                                      '"locator" is incorrect. (String | Function)',
                                  ),
                            d
                        );
                    },
                    filterDataByLocator: function (a) {
                        ...
                        if (i.isObject(a)) {
                            ...
                            d
                                ? i.isArray(d) ||
                                  c('dataSource.' + e + ' must be an Array.')
                    ...
                    observer: function () {
                        ...
                        j.on(h + 'go', function (d, e, f) {
                            (e = parseInt(b.trim(e))) &&
                                (b.isNumeric(e) ||
                                    c('"pageNumber" is incorrect. (Number)'),
                                a.go(e, f));
                        }),
                            d.delegate(
                                '.J-paginationjs-page',
                        ...
                        a.isDynamicTotalNumber && (f = 1),
                            k.triggerPagingOnInit &&
                                j.trigger(h + 'go', Math.min(f, e));
                    },
                };
            if (
                j.data('pagination') &&
                !0 === j.data('pagination').initialized
            ) {
                if (b.isNumeric(f))
                    return (
                        j.trigger.call(this, h + 'go', f, arguments[1]), this
                    );
                if ('string' == typeof f) {
        ...
        (b[g] = function (a, d) {
            ...
            var e;
            if (
                ((e = 'string' != typeof a && a instanceof jQuery ? a : b(a)),
                e.length)
            )
